...
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(message)s',
                    handlers=[logging.FileHandler("training_retinanet_node.log"),
...
def main():
    ...
    try:
        with open('retinanet_metrics_node.csv', mode='w', newline='') as file:
            ...
            for epoch in range(num_epochs):
                ...
                if val_metrics['f1'] > best_f1:
                    ...
                    torch.save(model.state_dict(), 'best_retinanet_model_node.pth')
        ...
        torch.save(model.state_dict(), 'retinanet_model_node_new.pth')
